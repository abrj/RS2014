...
In this section, the different implementation techniques of CF recommender systems will be described and a list of pro's and cons, be given towards the end. We will distinguish between what is known as user-based and item-based recommendations \todo{Kilde: Recommender Systems, An Introduction}. But before going into these descriptions, a short section for the common features will be explained\newline
...
The most common approach is therefore to define a user-item matrix as seen in the table below \todo{make sure text fits with table - and figure out if we are to reference the book the illustration were found}
