...
\todo{beskriv approach for at embedde values i et system: definer stakeholders, definer pros/cons for stakeholders, definer values ud far pros/cons}
...
\todo{I forhold til bias som en value, giv en indikation på, at ved ikke at implementere brugerinteraktion i systemet, har vi taget et skridt mod at der ikke opstår emergent bias i vores system}
