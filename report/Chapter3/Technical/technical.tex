...
\begin{itemize}
	...
	\item Der skelnes mellem tilmeldte og tidligere tilmeldte kurser, i forhold til best√•et kurser, for at undg√• at man bliver anbefalet kurser, som man er igang med p√• tidspunktet hvor anbefalingen falder. 
\end{itemize}
...
On the other hand, we also feel that a student who has attended a course at an earlier date, will be in a much better position to decide whether or not this course will be a future priority, than any system ever will.

Rune der tilvælger en liste med keywords vs. vilkårlig person der fravælger en liste med hverdagsord
mere personlig indblanden, skaber til gengæld mindre bias, muligvis mere relevans i de enkelte recommendations, da der ikke tilføjes ord der vil hælde systemet mod et specifikt område, men derimod vil bestå af interne keywords valgt af systemet selv ud fra kursusindholdet.

Our initial thought regarding keywords for the courses was to get one or more well respected persons whom in some way were related to the project to sit down and choose these. Our idea was to make the leaders of the different lines of study at ITU create a list full of all the keywords they found relevant in relation to their field of study.

This demands a precise notation of the course description for every course in order to be effective and ensure that our values are contained within the system
