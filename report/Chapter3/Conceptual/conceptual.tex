...
\begin{itemize}
	\item Teachers.
They are indirectly impacted in regards to whether students choose to sign up for their course(s) or not, since the course can potentially be canceled if there are not a minimum number of sign-ups.
